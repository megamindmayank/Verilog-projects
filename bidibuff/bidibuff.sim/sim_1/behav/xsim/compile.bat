...
REM
REM Generated by Vivado on Wed Jul 23 01:09:56 +0530 2025
...
echo "xvlog --incr --relax -prj tb_bidibuf_vlog.prj"
call xvlog  --incr --relax -prj tb_bidibuf_vlog.prj -log xvlog.log
