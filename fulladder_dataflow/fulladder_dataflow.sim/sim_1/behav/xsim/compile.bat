...
REM
REM Generated by Vivado on Tue Jul 15 22:55:27 +0530 2025
...
echo "xvlog --incr --relax -prj ta_fa_vlog.prj"
call xvlog  --incr --relax -prj ta_fa_vlog.prj -log xvlog.log
