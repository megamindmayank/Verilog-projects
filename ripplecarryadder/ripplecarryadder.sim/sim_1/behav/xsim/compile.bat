...
REM
REM Generated by Vivado on Thu Jul 17 23:34:58 +0530 2025
...
echo "xvlog --incr --relax -prj tb_ripadd_vlog.prj"
call xvlog  --incr --relax -prj tb_ripadd_vlog.prj -log xvlog.log
