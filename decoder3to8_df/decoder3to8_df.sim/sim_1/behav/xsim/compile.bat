...
REM
REM Generated by Vivado on Wed Jul 16 00:49:58 +0530 2025
...
echo "xvlog --incr --relax -prj tb_dec_vlog.prj"
call xvlog  --incr --relax -prj tb_dec_vlog.prj -log xvlog.log
