...
REM
REM Generated by Vivado on Tue Jul 15 22:41:32 +0530 2025
...
echo "xvlog --incr --relax -prj tbfa1_vlog.prj"
call xvlog  --incr --relax -prj tbfa1_vlog.prj -log xvlog.log
